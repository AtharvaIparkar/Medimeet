        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-8 ml-10">
                <Badge 
                variant='online'
                className='bg-emerald-900/30 border-emerald-700/30 px-4 py-2 text-sm font-medium'>
                  Healtcare made simple
                </Badge>
              ...
              <div className="relative h-[500px] w-[625px] rounded-xl overflow-hidden lg:ml-15">
                <Image 
                  src='/banner2.png' 
